...
class RolloutStorage(object):
    ...
    def __init__(self, num_steps, num_processes, eval_freq, num_repeats, num_robots, obs_shape, action_space, rec_state_size):
        ...
        self.mi_loss_preds = torch.zeros(num_steps + 1, num_processes * num_robots * num_repeats)
    ...
    def to(self, device):
        ...
        self.mi_loss_preds = self.mi_loss_preds.to(device)
    ...
    def insert(self, obs, rec_states, actions, action_log_probs, value_preds,mi_loss_preds,
               rewards, masks):
        ...
        self.mi_loss_preds[self.step][l:h].copy_(mi_loss_preds)
        ...
        if mini_batch_size > 0:
            ...
            for idx, indices in enumerate(sampler):
                ...
                raw_data = {
                    ...
                    'mi_loss_preds': self.mi_loss_preds[:-1].view(-1)[indices],
...
class GlobalRolloutStorage(RolloutStorage):
    ...
    def insert(self, obs, rec_states, actions, action_log_probs, value_preds,mi_loss_preds,
        ...
        super(GlobalRolloutStorage, self).insert(obs, rec_states, actions,
                                                 action_log_probs, value_preds,mi_loss_preds, rewards, masks)
