...
def get_parser():
    ...
    parser.add_argument('--use_single_gpu', type=int, default=1,
    ...
    parser.add_argument('--load_global', type=str, default="/home/NeuralCoMapping/train/models/infonce_915_train_mi1_1/model_best.global",
                        help='''model path to load,
                                0 to not reload (default: 0)''')
    ...
    parser.add_argument('--predict_loss_coef', type=float, default=0.05,
                        help='unexplored area predict loss coefficient (default: 1.0)')
